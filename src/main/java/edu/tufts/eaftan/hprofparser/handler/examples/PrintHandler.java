...
public class PrintHandler extends NullRecordHandler {
    ...
    public void stackFrame(
            long stackFrameId, long methodNameStringId,
    ...
    public void stackTrace(
            int stackTraceSerialNum, int threadSerialNum,
    ...
    public void allocSites(
            short bitMaskFlags, float cutoffRatio,
    ...
    public void startThread(
            int threadSerialNum, long threadObjectId,
    ...
    @Override
    public void rootThreadObj(
            long objId, int threadSerialNum,
    ...
    public void instanceDump(
            long objId, int stackTraceSerialNum,
